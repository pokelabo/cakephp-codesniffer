 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Pokelabo_Sniffs_Classes_PropertyDeclarationSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        // Pokelabo does not use underscore to indicate visibility
        // but to avoid conflict among property and __get() __set() methods.
        //
